...
^FO50,300
^A0N,20,20
^FD${fechaHora}^FS  // Fecha con hora abajo en la izquierda (fuente reducida)
// Colocando el código QR a la derecha
^FO350,120
^BQ,2,4  // QR más pequeño para evitar empalmarse
^FDQA,${codigoFinal}^FS  // Código QR con la cadena de datos
// Centrado del código debajo del QR (alineado con la fecha)
^FO280,300
^A0N,18,18
^FD${codigoFinal}^FS
